...
### git merge
 ...
 ### Дополнительные команды вы можете внести с это руководство по желанию.
...
## Здесь надо отредактировать ветку мастер и убрать дублирование после слияния. Конфликта бвыть не должно. Эта ветка создана только для слияния